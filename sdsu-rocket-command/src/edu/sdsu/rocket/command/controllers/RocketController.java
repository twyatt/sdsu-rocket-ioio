...
//		rocket.waitingForSensorData.set(false);
		...
		try {
			...
			// MAX31855-2 thermocouple
			rocket.ignitorTemperature.internal = buffer.getFloat();
			rocket.ignitorTemperature.thermocouple = buffer.getFloat();
			
			// MAX31855-1 thermocouple
